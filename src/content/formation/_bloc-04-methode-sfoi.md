...
**Audio** : `[À RÉENREGISTRER, ancien : Formation_prompting/.../04-5. Clôture.m4a, RÉÉCRITURE COMPLÈTE — passage à la nouvelle IMIA Option C, version intro]`
**Illustration** : `[À PRODUIRE, deux slides : (5a) S.F.O.I. au quotidien — récap des 4 actes + question récurrente ; (5b) bascule IMIA — 4 questions organisationnelles + annonce IMIA comme sujet du bloc 5]`
**Durée cible** : 2 min
 
### Script
 
<!-- TIMELINE: show cloture-marc-livre -->
 
Marc a livré sa charte vendredi matin. Solide. Parce qu'il avait suivi les actes dans l'ordre.
 
<!-- TIMELINE: show sfoi-universel-livrables -->
...
<!-- TIMELINE: show sfoi-question-quotidien -->
...
<!-- TIMELINE: show bascule-echelle-organisation -->
...
<!-- TIMELINE: show bascule-quatre-questions-org -->
...
<!-- TIMELINE: show sfoi-imia-conclusion -->
...
- Cette slide est désormais **découpée en deux** dans le PPT :
  - **(5a) S.F.O.I. au quotidien** — récap des 4 actes + question récurrente « à quel acte suis-je ? ». Marqueurs : `cloture-marc-livre`, `sfoi-universel-livrables`, `sfoi-question-quotidien`.
  - **(5b) Bascule vers IMIA** — 4 questions organisationnelles + annonce IMIA. Marqueurs : `bascule-echelle-organisation`, `bascule-quatre-questions-org`, `imia-acronyme`, `sfoi-imia-conclusion`.
- L'illustration de la slide 5b doit rester sobre : annoncer IMIA comme l'objet du bloc 5, sans détailler les 5 dimensions ni leurs pondérations. La composition complète de l'IMIA (Gouvernance 30 / Pratique S.F.O.I. 20 / Capital intellectuel 20 / Capacités humaines 20 / Infrastructure 10) est traitée au bloc 5, sur la slide IMIA pentagone.
- Aucune mention d'AI Practice Steward dans la clôture du bloc 4. Le rôle est posé au bloc 5. Ici on installe seulement le concept de carte de maturité — sans le développer.
- **Changement par rapport à l'ancienne version** : la mention de la composition « S.F.O.I. + autonomie collective » est retirée. Elle est remplacée par une simple annonce du concept IMIA, dont la nouvelle composition (cinq dimensions distinctes, dont la pratique S.F.O.I. n'est qu'une parmi d'autres) sera révélée au bloc 5.
